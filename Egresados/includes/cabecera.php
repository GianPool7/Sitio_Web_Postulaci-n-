...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-2 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="home.php">
        <img src="./assets/img/logo-ct.png" class="navbar-brand-img h-150" alt="main_logo">
    ...
    <div class="collapse navbar-collapse w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item mt-3">
          <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Seguimiento e Inserción</h6>
        </li>

        <li class="nav-item">
          <a class="nav-link text-white " href="Encuesta_egresado.php?idestudiante=<?php echo $idestudiante?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="fas fa-file-signature"></i>
            </div>
            <span class="nav-link-text ms-1">Actualiza tus Datos</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="actualizardatos.php?idestudiante=<?php echo $idestudiante?>">
            ...
            <span class="nav-link-text ms-1">Actualizar Perfil</span>
          </a>
        </li>
    ...
    <div class="text-center">
      <a href="mailto:oficinadeempleo@bpastor.edu.pe"><p style="font-size:13px" class="text-light">oficinadeempleo@bpastor.edu.pe</p></a>
      <a href="tel:+415-5638"><p style="font-size:13px" class="text-light"><span>Telefono :</span> 415-5630 <br> 415-5638 (6014)</p></a>
    </div>
            ...
            <ul class="navbar-nav  justify-content-end">
              ...
              <li class="nav-item dropdown pe-2 d-flex align-items-center">
                ...
                <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                  ...
                  <li class="mb-2">
                    <a class="dropdown-item border-radius-md" href="Ccontra.php?idestudiante=<?php echo $idestudiante?>">
                      <div class="d-flex py-1">
                        <!----
                        <div class="my-auto">
