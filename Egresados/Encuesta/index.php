<?php
  ...
  if (isset($_POST['actualizarsituacion'])) {
    ...
    $sql="UPDATE estudiante SET nombrese='$nombrese',apellidose='$apellidose',numdoce='$numdoce',telfe='$telfe',emaile='$emaile',direccione='$direccione',distritoe='$distritoe',semestreeg='$semestreeg',labura='$labura',Sexo='$Sexo',condicionestu='$condicionestu',cargoestu='$cargoestu',nombreempresaestud='$nombreempresaestud',remu='$remu',porqueestud='$porqueestud',razon='$razon',p1='$p1',p2='$p2',p3='$p3',p4='$p4',p5='$p5',fecha='$fecha' WHERE idestudiante=$idestudiante;";
      ...
      <div class="container text-center">
        <div class="row align-items-start">
          <div class="col">
            ...
            <form class="row g-3 p-5 text-center" action="index.php?idestudiante=<?php echo $_GET['idestudiante'];?>" method="post" enctype="multipart/form-data">  
...
<!----
                <div class="row p-4">     
                  ...
                  <label for="inputAddress2" class="form-label fw-bold">Objetivos</label>

                  <div class="mb-3">
                    <textarea class="form-control border-info p-2" style="border:1px solid black;" name="resumene" id="exampleFormControlTextarea1" rows="3"><?php //echo $resumene?></textarea>
                  </div>
                ...
                <div class="col-12 p-4">
                  <button type="button" class="btn btn-primary" id="btnsgtsino" onclick="verifica();">Siguiente</button>
                </div>
